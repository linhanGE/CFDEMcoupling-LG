...
defineTypeNameAndDebug(engineSearchDyM, 0);
...
engineSearchDyM::engineSearchDyM
(
...
label engineSearchDyM::findCell
(
    double** const& mask,
    double**& positions,
    double**& cellIDs,
...
label engineSearchDyM::findSingleCell
(
    vector& position,
    label& oldCellID
) const
...
label engineSearchDyM::intersection
(
    const point& pStart,
    const point& pEnd
) const
...
label engineSearchDyM::intersections
(
    const point& pStart,
    const point& pEnd
) const
...
label engineSearchDyM::findNearestCell
(
    const point& pStart
) const
{
